...
HD_PWD='C:/Users/socce/Downloads/Zybo-Z7-10-Pcam-5C-hw.xpr/Zybo-Z7-HW/Zybo-Z7-HW.runs/system_nand_gate_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_nand_gate_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_nand_gate_0_0.tcl
